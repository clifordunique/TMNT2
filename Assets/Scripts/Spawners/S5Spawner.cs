...
public class S5Spawner : MonoBehaviour {
	...
	void Update () {
		...
		if(go){
			if(goTime == 50){
				...
				spawnSFS(3, new Vector3(right, 80f, 80f), 2);
				stage = 3;
			}else if(goTime == 150){
				spawnSFS(4, new Vector3(right, 105f, 105f), 2);
				stage = 4;
			}else if(goTime == 200){
				spawnSFS(5, new Vector3(left, 105f, 105f), 1);
				stage = 5;
			}else if(goTime == 250){
				spawnSFS(6, new Vector3(left, 105f, 105f), 1);
				stage = 6;
				go = false;
				done1 = true;
			}
