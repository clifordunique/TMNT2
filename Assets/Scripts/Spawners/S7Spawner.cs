...
public class S7Spawner : MonoBehaviour {
	...
	void Update () {
		if(go){
			if(goTime == 0){
				...
				spawnBFS(2, new Vector3(right, 40f, 40f), 2);
				stage = 4;
				go = false;
				done1 = true;
			}
		...
		if(go2){
			if(goTime2 == 0){
				spawnBFS (1, new Vector3(right, 40f, 40f), 2);
				stage = 1;
			}else if(goTime2 == 50){
				spawnBFS(2, new Vector3(left, 105f, 105f), 1);
				stage = 2;
			}else if(goTime2 == 100){
